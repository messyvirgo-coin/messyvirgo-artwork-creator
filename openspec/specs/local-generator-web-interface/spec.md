...
Provide a simple local browser UI for Messy scene generation, avatar reference-set dry-run/generation, and background removal without adding a frontend framework or changing existing CLI semantics.
